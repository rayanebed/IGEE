...
function sendEmail(){
  Email.send({
    SecureToken: '97ab470d-2513-4f78-bb98-cdeb4755afe1',
    To : 'rayaneforbusiness@gmail.com',
    From : 'rayaneforbusiness@gmail.com',
    Subject : "Message sent (IGEE Website)",
    Body : "Name: " + naame.value + "<br>Email: " + emmail.value + "<br>Message: " + message.value
}).then(
  message => {
    if(message == 'OK'){
      alert('Your message has been sent to Rayane.');
    }
  }
);
}
...
//   To : 'rayaneforbusiness@gmail.com',
//   From : emmail.value,
//   Subject : "Message Sent by" + name.value,
//   Body : " Name: " + name.value + "<br> Email: " + emmail.value +
//           "<br> Message: " + message.value
// }).then(
// message => alert("We have successfully received your message.")
// );
// }